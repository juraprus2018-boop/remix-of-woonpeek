...
export const LEGACY_REDIRECTS: Array<{ from: string; to: string }> = [
  ...
  { from: "/huurwoningen", to: "/huurwoningen" },
  { from: "/koopwoningen", to: "/koopwoningen" },
  { from: "/appartement-huren", to: "/appartement-huren" },
  { from: "/huis-huren", to: "/huis-huren" },
  { from: "/studio-huren", to: "/studio-huren" },
  { from: "/kamer-huren", to: "/kamer-huren" },
  ...
  { from: "/huurwoningen/:city", to: "/huurwoningen/:city" },
  { from: "/huurwoningen/:city/:filter", to: "/huurwoningen/:city/:filter" },
  { from: "/koopwoningen/:city", to: "/koopwoningen/:city" },
  { from: "/koopwoningen/:city/:filter", to: "/koopwoningen/:city/:filter" },
  { from: "/appartement-huren/:city", to: "/appartement-huren/:city" },
  { from: "/appartement-huren/:city/:filter", to: "/appartement-huren/:city/:filter" },
  { from: "/huis-huren/:city", to: "/huis-huren/:city" },
  { from: "/huis-huren/:city/:filter", to: "/huis-huren/:city/:filter" },
  { from: "/studio-huren/:city", to: "/studio-huren/:city" },
  { from: "/studio-huren/:city/:filter", to: "/studio-huren/:city/:filter" },
  { from: "/kamer-huren/:city", to: "/kamer-huren/:city" },
  { from: "/kamer-huren/:city/:filter", to: "/kamer-huren/:city/:filter" },
