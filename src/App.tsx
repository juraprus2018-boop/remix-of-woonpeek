...
const Reacties = lazy(() => import("./pages/Reacties"));
...
const PAGES: RouteDef[] = [
  ...
  { path: "/huurwoning/:city/:slug", element: <PropertyDetail /> },
  { path: "/koopwoning/:city/:slug", element: <PropertyDetail /> },
  ...
  { path: "/huurwoningen", element: <ListingTypePage listingType="huur" /> },
  ...
  { path: "/koopwoningen", element: <ListingTypePage listingType="koop" /> },
  ...
  { path: "/reacties", element: <Reacties /> },
