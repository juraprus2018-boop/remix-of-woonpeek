      ...
      const marker = L.marker(
        ...
        <div style="min-width:220px;padding:4px 6px 6px;font-family:system-ui,sans-serif">
          ...
          <div style="display:flex;gap:6px;flex-wrap:wrap;padding-bottom:2px">
            <a href="${propertyPath(property as any)}" style="display:inline-block;padding:8px 14px;background:hsl(var(--primary));color:white;border-radius:6px;text-decoration:none;font-size:13px;font-weight:600;line-height:1">Bekijken →</a>
