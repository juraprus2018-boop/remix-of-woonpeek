    ...
    <section className="py-16 md:py-20">
      <div className="container">
        <div className="mx-auto max-w-3xl space-y-6 text-base md:text-lg leading-relaxed text-muted-foreground">
          ...
          <p>
            Op zoek naar een <strong>woning</strong> in Nederland? Stekly verzamelt dagelijks het
            ...
            <Link to="/kamers" className="text-primary hover:underline">kamer</Link>: bij Stekly vind je
            snel wat je zoekt.
          </p>
          <p>
          ...
          <p>
            ...
            <strong>woning zoeken</strong> via Stekly. Het is volledig gratis.
          </p>
        </div>
      </div>
    </section>
