...
export const EMAIL_TEMPLATES: Record<string, { name: string; subject: string; getHtml: (recipientName?: string) => string }> = {
  "makelaar-welkom": {
    ...
    subject: "Vergroot uw bereik met Huurbaasje",
...
<img src="${LOGO_URL}" alt="Huurbaasje" height="50" style="display:inline-block;" />
</div>
<div style="padding:30px;">
<p style="color:#1a365d;font-size:16px;margin:0 0 20px;">${name ? `Geachte ${name},` : "Geachte heer/mevrouw,"}</p>
<p style="color:#333333;font-size:14px;line-height:1.6;margin:0 0 15px;">Graag stellen wij ons voor: wij zijn <strong>Huurbaasje</strong>, een groeiend woningplatform in Nederland. Wij bieden makelaars de mogelijkheid om kosteloos hun woningaanbod bij ons te plaatsen.</p>
<p style="color:#333333;font-size:14px;line-height:1.6;margin:0 0 20px;">Door uw aanbod op Huurbaasje te plaatsen profiteert u van:</p>
...
<p style="color:#94a3b8;font-size:12px;margin:0;text-align:center;">Huurbaasje.nl | info@huurbaasje.nl</p>
</div>
</div>`,
  },
  "makelaar-herinnering": {
    name: "Makelaar Herinnering",
    subject: "Herinnering: plaats kosteloos uw woningen op Huurbaasje",
    getHtml: (name?: string) => `<div style="font-family:Arial,Helvetica,sans-serif;max-width:600px;margin:0 auto;background:#ffffff;border:1px solid #e2e8f0;">
<div style="background:#1a365d;padding:30px;text-align:center;">
<img src="${LOGO_URL}" alt="Huurbaasje" height="50" style="display:inline-block;" />
</div>
