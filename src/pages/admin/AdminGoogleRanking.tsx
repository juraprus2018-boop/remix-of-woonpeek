              ...
              {data.slice(0, 100).map((item) => (
                <TableRow key={item.url} className="cursor-pointer hover:bg-muted/50" onClick={() => openDetail(item.url)}>
                  <TableCell className="max-w-xs">
                    <p className="truncate text-sm font-medium">{item.url.replace("https://domora.com", "")}</p>
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            <h2 className="text-lg font-bold truncate">{selectedUrl.replace("https://domora.com", "")}</h2>
              ...
              <Table>
                ...
                <TableBody>
                  {indexingLog.map((log) => (
                    <TableRow key={log.id}>
                      <TableCell className="max-w-xs">
                        <p className="truncate text-sm">{log.url.replace("https://domora.com", "")}</p>
                      </TableCell>
