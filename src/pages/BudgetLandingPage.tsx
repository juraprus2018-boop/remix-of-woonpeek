...
const BudgetLandingPage = ({ listingType }: BudgetLandingPageProps) => {
  ...
  const title = `${listingType === "huur" ? "Huurwoningen" : "Koopwoningen"} onder ${formattedBudget} in ${cityName} | Domora`;
  ...
  const faqItems: FAQItem[] = listingType === "huur"
    ? [
        ...
        },
        {
          ...
          answer: `Het aanbod van betaalbare huurwoningen in ${cityName} is competitief: woningen worden vaak binnen enkele dagen verhuurd. Stel een gratis dagelijkse alert in op Domora zodat je direct een e-mail krijgt zodra een passende woning online komt.`,
        },
        {
          question: "Hoe vaak wordt het aanbod bijgewerkt?",
          answer: "Domora verzamelt dagelijks het nieuwste woningaanbod uit tientallen bronnen. Nieuw aanbod is meestal binnen enkele uren na publicatie zichtbaar op de site.",
        },
      ]
    : [
        {
        ...
        {
          question: "Worden bezichtigingen via Domora geregeld?",
          answer: "Nee, Domora is een aggregator: we tonen het aanbod en verwijzen direct door naar de aanbieder of makelaar. Bezichtigingen plan je rechtstreeks via de oorspronkelijke aanbieder.",
        },
      ];
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <SEOHead
        ...
        canonical={`https://domora.com/${listingType === "huur" ? "huurwoningen" : "koopwoningen"}-onder-${budgetNum}-${city}`}
      />
      <Header />
