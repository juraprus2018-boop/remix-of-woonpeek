...
const MakelaarKoppelen = () => {
  ...
  const steps = [
    ...
    { icon: Link2, title: "Voeg je XML feed of CRM toe", desc: "Wij koppelen jouw systeem aan Woonaanbod NL." },
  ...
  return (
    <>
      <SEOHead
        title="Makelaar woningen koppelen – Automatisch plaatsen op Woonaanbod NL"
        description="Koppel je XML feed of makelaarssoftware en toon al je woningen automatisch op Woonaanbod NL. Geen handmatig invoeren, binnen 2 minuten geregeld."
      />
      <Header />
          ...
          <div className="container mx-auto px-4 py-20 md:py-28 relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold text-primary-foreground leading-tight mb-6">
                ...
                <span className="text-accent">automatisch</span> op Woonaanbod NL
              </h1>
        ...
        <section className="py-16 md:py-24 bg-background">
          <div className="container mx-auto px-4">
            <h2 className="text-2xl md:text-4xl font-bold text-foreground text-center mb-12">
              Waarom makelaars voor Woonaanbod NL kiezen
            </h2>
