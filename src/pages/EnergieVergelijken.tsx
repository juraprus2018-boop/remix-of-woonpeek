...
const EnergieVergelijken = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <SEOHead
        title="Energie vergelijken – Bespaar op gas en stroom | Domora"
        description="Vergelijk de actuele energietarieven van alle grote leveranciers en bespaar tot € 600 per jaar. Eenvoudig, vrijblijvend en gratis overstappen via Domora."
        canonical="https://domora.com/energie-vergelijken"
      />
      <script
        ...
        <section className="py-10 md:py-14">
          <div className="container">
            ...
            <p className="mt-3 text-center text-xs text-muted-foreground">
              Vergelijking aangeboden via Daisycon. Domora ontvangt mogelijk een
        ...
        <section className="border-t bg-muted/30 py-12 md:py-16">
          <div className="container">
            <h2 className="text-2xl font-bold md:text-3xl">
              Waarom energie vergelijken via Domora?
            </h2>
