...
const EnergieVergelijken = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <SEOHead
        title="Energie vergelijken – Bespaar op gas en stroom | Stekly"
        description="Vergelijk de actuele energietarieven van alle grote leveranciers en bespaar tot € 600 per jaar. Eenvoudig, vrijblijvend en gratis overstappen via Stekly."
        canonical="https://stekly.nl/energie-vergelijken"
      />
      <script
        ...
        <section className="py-10 md:py-14">
          <div className="container">
            ...
            <p className="mt-3 text-center text-xs text-muted-foreground">
              Vergelijking aangeboden via Daisycon. Stekly ontvangt mogelijk een
        ...
        <section className="border-t bg-muted/30 py-12 md:py-16">
          <div className="container">
            <h2 className="text-2xl font-bold md:text-3xl">
              Waarom energie vergelijken via Stekly?
            </h2>
