...
const CityComparePage = () => {
  ...
  const pageTitle = `Huurprijzen ${cityName1} vs ${cityName2}: vergelijking woningmarkt (${currentMonth} ${currentYear}) | Woonaanbod NL`;
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <SEOHead title={pageTitle} description={pageDescription} canonical={`/duel/${slug1}-vs-${slug2}`} />
      <Header />
