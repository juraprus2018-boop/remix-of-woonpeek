...
const NewListingsCity = () => {
  ...
  const pageTitle = `Nieuw aanbod in ${cityName} vandaag – nieuwe woningen | Domora`;
  const pageDescription = `Bekijk ${totalCount} nieuwe woningen in ${cityName} van vandaag (${dateLabel}). Ontdek de nieuwste huurwoningen en koopwoningen als eerste op Domora.`;
  const canonical = `https://domora.com/nieuw-aanbod/${citySlug}`;
        ...
        <section className="border-t bg-muted/30 py-12">
          <div className="container max-w-3xl">
            ...
            <div className="space-y-3 text-sm text-muted-foreground leading-relaxed">
              ...
              <p>
                Domora scant dagelijks meerdere woningplatforms in heel Nederland. Nieuwe woningen in {cityName} worden
