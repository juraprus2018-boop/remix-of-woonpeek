...
const VARIANT_CONFIG: Record<BestOfVariant, {
  ...
  "goedkoopste-huur": {
    ...
    metaTitle: (city, count) => `Top 10 goedkoopste huurwoningen ${city} (${new Date().getFullYear()}) | Domora`,
    metaDesc: (city, count) =>
  ...
  "grootste-huur": {
    ...
    intro: (city) =>
      `Veel ruimte nodig in ${city}? Deze top 10 van grootste huurwoningen toont het ruimste aanbod op Domora. Ideaal voor gezinnen, woongroepen of wie thuis wil werken zonder concessies.`,
    metaTitle: (city, count) => `Top 10 grootste huurwoningen ${city} (${new Date().getFullYear()}) | Domora`,
    metaDesc: (city, count) =>
  ...
  "beste-buurten": {
    ...
    metaTitle: (city, count) => `Top 10 beste buurten van ${city} om te wonen (${new Date().getFullYear()}) | Domora`,
    metaDesc: (city, count) =>
...
const BestOfCityPage = ({ variant }: BestOfCityPageProps) => {
      ...
      return [
        {
          ...
          answer: cheapest
            ...
            : `Er zijn momenteel geen actieve huurwoningen in ${validCityName} op Domora. Stel een gratis alert in om direct bericht te krijgen zodra een betaalbare woning beschikbaar komt.`,
        },
        {
          question: `Hoe vind ik een betaalbare huurwoning in ${validCityName}?`,
          answer: `Reageer snel op nieuw aanbod. Domora bundelt dagelijks woningen uit tientallen bronnen. Stel een dagelijkse e-mailalert in zodat je nooit een goedkope huurwoning in ${validCityName} mist.`,
        },
        {
  ...
  const canonical = `https://domora.com/${config.pathPrefix}/${citySlug}`;
