...
const VARIANT_CONFIG: Record<BestOfVariant, {
  ...
  "goedkoopste-huur": {
    ...
    metaTitle: (city, count) => `Top 10 goedkoopste huurwoningen ${city} (${new Date().getFullYear()}) | Woonaanbod NL`,
    metaDesc: (city, count) =>
  ...
  "grootste-huur": {
    ...
    metaTitle: (city, count) => `Top 10 grootste huurwoningen ${city} (${new Date().getFullYear()}) | Woonaanbod NL`,
    metaDesc: (city, count) =>
  ...
  "beste-buurten": {
    ...
    metaTitle: (city, count) => `Top 10 beste buurten van ${city} om te wonen (${new Date().getFullYear()}) | Woonaanbod NL`,
    metaDesc: (city, count) =>
      ...
      return [
        {
          ...
          answer: cheapest
            ...
            : `Er zijn momenteel geen actieve huurwoningen in ${validCityName} op Woonaanbod NL. Stel een gratis alert in om direct bericht te krijgen zodra een betaalbare woning beschikbaar komt.`,
        },
        {
          question: `Hoe vind ik een betaalbare huurwoning in ${validCityName}?`,
          answer: `Reageer snel op nieuw aanbod. Woonaanbod NL bundelt dagelijks woningen uit tientallen bronnen. Stel een dagelijkse e-mailalert in zodat je nooit een goedkope huurwoning in ${validCityName} mist.`,
        },
        {
