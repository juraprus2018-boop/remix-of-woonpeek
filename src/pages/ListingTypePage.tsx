...
const ListingTypePage = ({ listingType }: ListingTypePageProps) => {
  ...
  const pageTitle = cityName
    ? `${label.plural} ${cityName}: ${hasListings ? `${totalCount} woningen` : "aanbod"} te ${listingType} (${currentMonth} ${currentYear}) | Domora`
    : `${label.plural} Nederland: actueel aanbod te ${listingType} | Domora`;
  ...
  const pageDesc = cityName
    ...
    : `Bekijk ${hasListings ? totalCount : "alle"} ${label.plural.toLowerCase()} in heel Nederland. Vergelijk prijzen, bekijk foto's en vind jouw ${label.singular} op Domora.`;

  const canonical = cityName
    ? `https://domora.com/${label.slug}/${citySlug}`
    : `https://domora.com/${label.slug}`;
  ...
  const faqItems = useMemo(() => {
    const items = [
      {
        ...
        answer: hasListings
          ? `Op dit moment staan er ${totalCount} ${label.plural.toLowerCase()} in ${locationLabel} op Domora. Het aanbod wordt dagelijks bijgewerkt uit meerdere bronnen.`
      ...
      },
      {
        ...
        answer: `Domora verzamelt dagelijks nieuw woningaanbod uit meerdere bronnen. Stel een gratis dagelijkse alert in om als eerste te reageren op nieuwe ${label.plural.toLowerCase()} in ${locationLabel}.`,
      },
      {
    ...
    if (listingType === "huur") {
      ...
      items.push({
        ...
        answer: `De koopwoningmarkt in ${locationLabel} is dynamisch. Bekijk het actuele aanbod en vergelijk prijzen om een goed beeld te krijgen. Domora toont dagelijks nieuw aanbod zodat je geen kans mist.`,
      });
    }
    return items;
          ...
          <div className="container">
            ...
            <div>
              ...
              <p className="mt-3 text-base leading-relaxed text-muted-foreground">
                ...
                Domora verzamelt dagelijks het nieuwste aanbod uit tientallen bronnen, zodat je sneller vindt wat je zoekt.
              </p>
        ...
        <section className="border-t bg-muted/30 py-12">
          <div className="container">
            ...
            <div className="mt-4 space-y-4 text-base leading-relaxed text-muted-foreground">
              <p>
                Op Domora vind je het meest actuele aanbod van <strong>{label.plural.toLowerCase()} in {locationLabel}</strong>.
              ...
              {listingType === "huur" ? (
                <>
                  <p>
                    ...
                    Daarom is het belangrijk om snel te reageren op nieuwe advertenties. Met Domora heb je een
                ...
                <>
                  <p>
                    ...
                    {cityName ? ` in ${cityName}` : ""}</strong> of een ruime gezinswoning, op Domora vind je
              ...
              {cityName && (
                <p>
                  Naast {label.plural.toLowerCase()} vind je op Domora ook{" "}
