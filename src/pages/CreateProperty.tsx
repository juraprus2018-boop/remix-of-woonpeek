...
const CreateProperty = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-muted/30">
      <SEOHead title="Woning plaatsen | Stekly" description="Plaats gratis je huur- of koopwoning op Stekly." canonical="https://stekly.nl/plaatsen" />
      <Header />
            ...
            <div className="rounded-2xl border bg-card p-6 shadow-sm md:p-10">
              ...
              {step === 0 && (
                <div className="space-y-6">
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-wider text-primary">Je woning plaatsen op Stekly</p>
                  ...
                  <div className="rounded-lg border border-primary/20 bg-primary/5 p-4">
                    <h3 className="font-display text-sm font-semibold text-foreground">Voordelen van plaatsen op Stekly</h3>
