...
const HuurprijsMonitor = () => {
  ...
  const pageTitle = `Gemiddelde huurprijs ${cityName} ${currentMonth} ${currentYear}: actueel overzicht | Domora`;
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <SEOHead title={pageTitle} description={pageDescription} canonical={`https://domora.com/huurprijzen/${citySlug}`} />
      <Header />
