...
const HuurprijsMonitor = () => {
  ...
  const pageTitle = `Gemiddelde huurprijs ${cityName} ${currentMonth} ${currentYear}: actueel overzicht | Woonaanbod NL`;
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <SEOHead title={pageTitle} description={pageDescription} canonical={`https://www.woonaanbod-nl.nl/huurprijzen/${citySlug}`} />
      <Header />
