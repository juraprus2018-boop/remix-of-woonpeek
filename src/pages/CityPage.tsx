...
const CityPage = () => {
  ...
  const canonical = `https://domora.com${cityPath(cityName)}`;

  // ── City FAQ items ──
  const cityFaqItems = useMemo(() => [
    {
      question: `Hoeveel woningen zijn er beschikbaar in ${cityName}?`,
      answer: `Op dit moment staan er ${totalCount} woningen in ${cityName} op Domora, waarvan ${huurCount} huurwoningen en ${koopCount} koopwoningen. Het aanbod wordt dagelijks bijgewerkt.`,
    },
    {
      question: `Wat kost een huurwoning in ${cityName}?`,
      answer: `De huurprijzen in ${cityName} variëren per woningtype en locatie. Gebruik de filters op deze pagina om te zoeken op jouw maximale budget. Domora toont ${huurCount} huurwoningen in ${cityName}.`,
    },
    {
    ...
    },
    {
      ...
      answer: `Domora verzamelt dagelijks nieuw woningaanbod uit meerdere bronnen. Stel een dagelijkse alert in om als eerste te reageren op nieuwe woningen in ${cityName}. Je kunt ook filteren op prijs, kamers en oppervlakte.`,
    },
    ...
    () => [
      ...
      // ItemList / Carousel (Google-supported rich result)
      {
        ...
        itemListElement: filteredProperties.slice(0, 10).map((property, index) => ({
          "@type": "ListItem",
          position: index + 1,
          url: `https://domora.com/woning/${property.slug || property.id}`,
          name: property.title,
            ...
            <div className="rounded-2xl border bg-card p-6">
              ...
              <div className="mt-4 space-y-3 text-base leading-relaxed text-muted-foreground">
                <p>
                  ...
                  Domora bundelt dagelijks het nieuwste aanbod van tientallen bronnen op een plek.
                </p>
                <p>
          ...
          <div className="container">
            ...
            <div className="mt-4 space-y-4 text-base leading-relaxed text-muted-foreground">
              <p>
                ...
                Domora doorzoekt dagelijks tientallen bronnen en toont het nieuwste aanbod
