...
const BudgetTool = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <SEOHead
        title={`Wat kun je ${isHuur ? "huren" : "kopen"} voor ${formatPrice(budget)}${isHuur ? "/mnd" : ""}? | Stekly`}
        ...
        canonical="https://stekly.nl/budget-tool"
      />
      <Header />
      ...
      <main className="flex-1">
        <div className="container py-8 lg:py-12">
          ...
          <div className="mt-16 mx-auto max-w-3xl space-y-4 text-sm leading-relaxed text-muted-foreground">
            ...
            <p>
              Stekly verzamelt dagelijks het nieuwste woningaanbod uit heel Nederland. De getoonde
